...
def main():
    ...
    savings_result = create_savings_account(savings_balance, savings_interest, savings_maturity)

    # Print out the interest earned and updated savings account balance with interest earned for the given months.
    # ADD YOUR CODE HERE
    print(f"Savings Interest Earned: ${savings_result['Interest Earned']:.2f}")
    print(f"Updated Savings Balance: ${savings_result['Updated Balance']:.2f}\n")
    ...
    # ADD YOUR CODE HERE
    print(f"CD Interest Earned: ${cd_result['Interest Earned']:.2f}")
